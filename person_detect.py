...
class PersonDetect:
    ...
    def __init__(self, model_name, device, stream_, threshold=0.60):
    ...
    def predict(self, image):
        ...
        outputs=self.net.infer(inputs={self.input_name: processed_image})
    ...
    def draw_outputs(self, coords, image):
        ...
        color = (0, 0, 255)
        for coord in coords:
            cv2.rectangle(image, (coord[0], coord[1]), (coord[2], coord[3]), color, thickness)
...
def main(args):
    ...
    pd.set_output_frame_size(initial_w, initial_h)
